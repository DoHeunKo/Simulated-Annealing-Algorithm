...
### 소감 
이번 과제는 내용도 그렇고 이해하기가 상당히 어려웠던 것 같다. 며칠을 개념만 봤던 것 같은데 다 하고 나서도 찝찝한 기분이 든다... 그래도 하나씩 정리하면서 코드를 짜보고 다양한 자료들을 읽으면서 이해를 해서 끝까지 했던 것 같다. 비전공자라 개념을 보고 코드를 짜는게 익숙하지 않아 상당히 힘들었던 학기였지만 나름 즐기면서 수업을 듣고 따라갔던 것 같다. 
